...
def train(config: dict, model: Model, train_loader: DataLoader, val_loader: DataLoader, early_stop: EarlyStopping, save_epochs: bool, train_losses: list, test_losses: list):    
    ...
    for epoch in range(config['epochs']):        
        ...
        if (epoch+1) % test_every == 0:
            ...
            early_stop(sum_test_loss, model, save_model=True, save_prefix='best')
